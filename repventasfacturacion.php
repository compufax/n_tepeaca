...
if($_POST['cmd']==2){
	...
	if($_POST['cliente'] > 0 && $monto > 0){
		$insert = "INSERT facturas SET plaza='{$_POST['plaza']}',serie='{$row['serie']}',folio='{$row['folio_inicial']}',fecha=CURDATE(),fecha_creacion=CURDATE(),hora=CURTIME(),obs='".addslashes($_POST['obs'])."',
