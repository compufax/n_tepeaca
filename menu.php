...
?>
		<li class="nav-item menuprincipal">
			<span style="cursor:pointer;" class="nav-link" onClick="$('.sidebar').find('.nav-item').removeClass('active');$(this).parents('li:first').addClass('active'); menu(0, '277', 'estatus_ticket_facturacion.php', 'Estatus Ticket Facturacion', '<?php echo $_SESSION['reg_sistema'];?>');">
			    <span>Estatus Ticket Facturaci&oacute;n</span>
			</span>
		</li>
<?php
