...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-light sidebar accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center nav-link_2" href="principal.php">
	  <!-- class="sidebar-brand-text mx-3 nav-link" -->
        <div class=""><font color="#000000">Verificaci&oacute;n Tepeaca</font></div>
      </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!--<div class="input-group" id="nombrepagina">
              Inicio
            </div>-->
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="companyDropdown">
                ...
                ?>
                  <span class="dropdown-item text-danger" onClick="cambiarPlaza(<?php echo $row['cve'];?>, $(this));" style="width:500px">
                    <?php echo $row['numero'].' '.$row['nombre']; ?>
                  </span>
                <?php
                  }
                ?>
  ...
  <script>
    $("#modalbusquedas").modal({
     ...
     <?php
      if($plaza['cve']>0){
    ?>
    $('#nombreplazatop').html('<?php echo $plaza['nombre'];?>');
