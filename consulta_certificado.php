...
?>
	...
	<table class="table">
	  <thead>
	    <tr>
	      ...
	      <th scope="col" style="text-align: center;">Tipo Vehiculo</th> 
	      <th scope="col" style="text-align: center;">Tipo Prueba</th> 
	...
	?>
	    <tr>
	      ...
	      <td align="left"><?php echo utf8_encode($row['nommodelo']);?></td>
	      <td align="left"><?php echo utf8_encode($row['nommarcar']);?></td>
	      <td align="left"><?php echo utf8_encode($row['nomtecnico']);?></td>
	      <td align="left"><?php echo utf8_encode($row['nomlinea']);?></td>
	      <td align="left"><?php echo utf8_encode($row['nomtipovehiculo']);?></td>
	      <td align="left"><?php echo utf8_encode($row['nomtipoprueba']);?></td>
