...
function obtener_informacion($datos){
	...
	IFNULL(i.nombre, '') as nomengomadoentregado, j.usuario, a.obscan, k.nombre as nomintento, a.obs, IF(a.estatus='C','Cancelado',IF(a.estatus='D', 'Devuelto', 'Activo')) as nomestatus, a.certificado_anterior, l.cve as clv_fact
	...
	LEFT JOIN claves_facturacion l ON l.ticket = a.cve AND a.plaza = l.plaza
...
?>
	...
	<table class="table">
	  <thead>
	    <tr>
		  ...
		  <th scope="col" style="text-align: center;">Clave de Facturacion</th> 
	...
	?>
	    <tr>
		  ...
		  <td align="center"><?php echo $row['clv_fact'];?></td>
